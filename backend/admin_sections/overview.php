    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          <div class="inner">
            <?php $coursetags = fetchTags();
            if (is_array($coursetags)) { ?>
              <h3><?php echo count($coursetags); ?></h3>
            <?php  } else { ?>
              <h3>0</h3>
            <?php }
            ?>
          ...
          <a href="?page=admin-course-list" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-danger">
          ...
          <a href="?page=admin-quiz" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
